...
public class Tally extends Entry {
   ...
   */
  public Tally(PublicKey teller, ArrayList<Entry> inputEntries) throws IllegalArgumentException {
    super();
    this.teller = teller;
   ...
   *     are itself not validated
   */
  public Tally(PublicKey teller, Elections elections, ArrayList<Vote> votes) {
    this.teller = teller;
   ...
   * @throws IllegalArgumentException if any of the Vote objects don't match the Elections object or
   *     are itself not validated
   * @return the list of the TransactionOutput objects generated by this Tally
   */
  @Override
   ...
   * Processes this Tally. Performs basic validation checks and sets up the id of this Tally.
   *
   * <p>Uses VotesTeller to tally the votes - count them and output a summary. The returned value of
   * VotesTeller's tally method is used as the metadata dictionary of this Tally. To customize the
   * metadata, supply a class inheriting from VotesTeller to setVotesTeller method of this Tally.
   *
   * @param elections the Elections object representing the elections that get tallied in this Tally
   * @param votes the list of Vote objects to tally
   * @return the list of TransactionOutput objects generated by this Tally - an empty list
   * @throws IllegalArgumentException if any of the Vote objects don't match the Elections object or
   *     are itself not validated
   */
  ...
  public final ArrayList<TransactionOutput> processEntry() throws RuntimeException {
    ...
    if (this.votesTeller == null) {
      setVotesTeller(new VotesTeller(elections, votes));
    }
    this.metadata = votesTeller.tallyVotes();
